    ...
    <aside className="row-span-full flex flex-col py-2 border-r border-slate-600 ease-in-out duration-500 relative">
      ...
      >
        ...
        >
          <button
            className={
              !activeMenu
                ? `text-[#3a6df0] hover:text-[#3a6df0] transition-all ease-in-out duration-200`
                : "text-[#e2e2e2]"
            }
          >
      ...
      <div className="flex justify-center py-8 border-b border-slate-600">
        ...
        >
          <Link
            to="/"
            className="flex justify-center px-2  transition-all ease-in-out duration-150  "
          >
      ...
      <ul className="flex flex-col py-4 gap-3 h-full justify-between">
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <ul
              className={`transition-all ease-in-out duration-300 overflow-hidden text-sm ${
          ...
          <li className="relative">
            ...
            >
              <NavLink
                ...
                className="flex items-center text-slate-200 gap-3  py-2 px-4 hover:bg-[#0c0f194d]  hover:text-[#3a6df0] transition-all ease-in-out duration-150  "
              >
                <button className="hover:text-[#3a6df0] transition-all ease-in-out duration-200 rotate-180">
