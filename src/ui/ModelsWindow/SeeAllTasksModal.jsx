...
function SeeAllTasksModal({
  ...
  return (
    <ModalWindow isModalOpen={allTasksOpen} closeModal={closeAllTasksModal}
    >
      <div className="flex flex-col h-[600px] justify-between my-4">
        <div className="overflow-y-scroll custom-scrollbar mx-3 ">
